...
def validate_card_number(card_number):
    ...
    elif (card_number.startswith("34") or card_number.startswith("37")) and card_number_length == 15: print("AMEX")
    elif card_number.startswith("4") and (card_number_length == 13 or card_number_length == 16): print("VISA")
